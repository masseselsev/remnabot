...
trial-instruction-promo-subtitle = 🔸 <b>Вариант 3 (Активация промокода)</b>
trial-instruction-promo-steps = 
    • Нажмите кнопку 🎁 <b>3 дня бесплатно!</b> в главном меню.
    • Введите ваш промокод.
    • Если код верный, ваша подписка сразу появится в профиле.
    
    <i>Где взять код? Можно использовать имена (имя пользователя \ username) существующих пользователей первого уровня (не tg_xxxxxxxxx), если вы их знаете!
