...
trial-friend-already-exists = ❌ У этого пользователя уже есть аккаунт в системе.
trial-friend-created = ✅ Аккаунт для <b>{ $name }</b> создан! Перешлите другу эту ссылку:
